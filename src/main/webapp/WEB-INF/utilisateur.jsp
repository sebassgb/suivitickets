...
<body>
    ...
    <center>
        <h1 class="hit-the-floor">Liste des utilisateurs</h1>
    </center>
                ...
                <ul>
                    <li>Utilisateur: ${utilisateurs.getUsername()} <br>
                        ...
                        Quelle rôle vous avez besoin de changer? <form method="post">
                            ...
                            <button class="autorisation" type="submit" name="TODO" value="autorisation"> Modifier
                                autorisation </button>
                            <button class="logout" type="submit" name="TODO"
                                value="supprimerUtilisateur">Supprimer</button>
                        </form>
