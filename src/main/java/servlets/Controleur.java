                ...
                switch (todo) {
                    case "log":
                        ...
                        if (m != null) {
                            ...
                            if (m.getUser_profil_id().equals("agent")) {//Ici on fait les vérifications pour savoir si l'utilisateur a le droit d'y accéder
                                request.setAttribute("responsable_ticket", ((Agent) m).getResponsable_ticket());
                                request.getRequestDispatcher("WEB-INF/home.jsp").forward(request, response);
                            } else if (m.getUser_profil_id().equals("gestionaire")) {//Ici on fait les vérifications pour savoir si l'utilisateur a le droit d'y accéder
                            ...
                            } else if (m.getUser_profil_id().equals("client")) {//Ici on fait les vérifications pour savoir si l'utilisateur a le droit d'y accéder
                            ...
                            } else if (m.getUser_profil_id().equals("admin")) {//Ici on fait les vérifications pour savoir si l'utilisateur a le droit d'y accéder
